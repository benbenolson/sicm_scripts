...
function offline {
  ...
  PEBS_FILE="${BASEDIR}/../../${PEBS_SIZE}/profile_all_and_allocs:${PEBS_FREQ}_${PEBS_RATE}_${CAP_INTERVAL}/i0/stdout.txt"
  ...
  cat "${PEBS_FILE}" | \
    sicm_hotset MEM_LOAD_UOPS_RETIRED:L3_MISS alloc_size ${PACK_ALGO} constant ${UPPER_SIZE} 1 ${PEAK_RSS_BYTES} \
